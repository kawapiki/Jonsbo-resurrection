...
3. Commit and push the reviewed source to `master`, then create and push the matching annotated tag, for example `git tag -a v0.3.0 -m "Jonsbo Resurrection v0.3.0"` and `git push origin v0.3.0`.
